...
namespace Contabilidad_General.Entidades
{
    public class Empleado
    {
        ...
        public String IdeEmpleado { get => idEmpleado; set => idEmpleado = value; }
        ...
        private String Celular_empleado { get => celular_empleado; set => celular_empleado = value; }
        private String Correo_empleado { get => correo_empleado; set => correo_empleado = value; }
        private String Direccion_empleado { get => direccion_empleado; set => direccion_empleado = value; }
        private float Sueldo { get => sueldo; set => sueldo = value; }
